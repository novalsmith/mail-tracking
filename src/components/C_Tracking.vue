...
<template>
    <v-container>
        ...
        <v-card class="my-5">
            <v-card-title>Filter
                <v-spacer></v-spacer>
                <v-btn v-if="userLocalData.roleLevel == 0 || userLocalData.roleLevel == 1 || userLocalData.roleLevel == 2"
                    @click="dialogReview = true" text small color="cyan darken-2 mr-2" class="white--text">
    ...
    data() {
        return {
            ...
            headersReview: [
                ...
                { text: 'Keterangan', value: 'ket', width: '5%' },
